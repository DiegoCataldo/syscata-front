...
import { startOfYear, endOfYear, addMonths, format, parseISO } from 'date-fns';
import DailysTable from '../../../Components/Containers/HomeDashboard/ListaDailysTable';
import dayjs from 'dayjs';
import "dayjs/locale/es";
import moment from 'moment-timezone';
import Carousel from 'react-material-ui-carousel'
import '../../../Components/Containers/HomeDashboard/style.css'
...
export default function Home() {
    ...
    const fetchData = async (page, rowsPerPage) => {
        try {
            ...
            const timeZone = 'America/Santiago'; // Cambia esto a tu zona horaria
            ...
            const calendarEvents = dailys.map((daily) => ({
                ...
                allDay: true,
                start: new Date(moment.tz(daily.date, timeZone).format('YYYY-MM-DD HH:mm:ss')), //para pasarlo a hora de chile, sino me tiraba un dia anterior
                end: new Date(moment.tz(daily.date, timeZone).format('YYYY-MM-DD HH:mm:ss')),
            }));
                        ...
                        <div style={{ padding: '1.25rem' }} className="card-block">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px' }} className="">Nombre Contrato</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400', marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{contract.nombre_contrato}
                                    </h6>
                                </div>
                                <div className="col-sm-6">
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px',fontSize: '15px' }} className="">API</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400',marginBottom: '10px', fontSize: '14px', marginTop:'0px'}} className="">{contract.API}
                                    </h6>
                                </div>
                                <div className="col-sm-6">
                                    <p style={{ lineHeight: '25px', fontWeight: '400',marginBottom: '0px',fontSize: '15px' }} className="">Proyecto</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400',marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{contract.proyecto}
                                    </h6>
                                </div>
                                <div className="col-sm-6">
                                    <p style={{ lineHeight: '25px', fontWeight: '400',marginBottom: '0px', fontSize: '15px' }} className="">Fecha Inicio</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400', marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{formatDate(contract.fecha_inicio)}
                                    </h6>
                                </div>
                                <div className="col-sm-6">
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px' }} className="">Fecha Término</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400', marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{formatDate(contract.fecha_fin)}
                                    </h6>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                {contract.encargadoContratista?.map((encargado, index) => (
                                    <div className="col-sm-6" key={index}>
                                        <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px' }} className="">{encargado.name}</p>
                                        <h6 style={{ color: '#919aa3', fontWeight: '400',marginBottom: '10px', fontSize: '14px', marginTop:'0px'}} className="">{encargado.email}
                                        </h6>
                                    </div>
                                ))}
                        ...
                        <div style={{ padding: '1.25rem' }} className="card-block">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6" style={{ borderTop: '1px solid rgb(224, 224, 224)', marginTop: '2rem', }}>
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px', marginTop: '0.5rem' }} className="">Revisión Obligatoria</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400', marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{contract.revisorPYCRequired ? 'Si' : 'No'}
                                    </h6>
                                </div>
                    ...
                    <Grid item xs={8} md={8} lg={8} >
                        <div style={{ padding: '1.25rem' }} className="card-block">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6" style={{ borderTop: '1px solid rgb(224, 224, 224)', marginTop: '2rem', }}>
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px', marginTop: '0.5rem' }} className="">Revisión Obligatoria</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400', marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{contract.revisorCCRequired ? 'Si' : 'No'}
                                    </h6>
                                </div>
                    ...
                    <Grid item xs={8} md={8} lg={8} >
                        <div style={{ padding: '1.25rem' }} className="card-block">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6" style={{ borderTop: '1px solid rgb(224, 224, 224)', marginTop: '2rem', }}>
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px', marginTop: '0.5rem' }} className="">Revisión Obligatoria</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400',marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{contract.revisorRRLLRequired ? 'Si' : 'No'}
                                    </h6>
                                </div>
                    ...
                    <Grid item xs={8} md={8} lg={8} >
                        <div style={{ padding: '1.25rem' }} className="card-block">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6" style={{ borderTop: '1px solid rgb(224, 224, 224)', marginTop: '2rem', }}>
                                    <p style={{ lineHeight: '25px', fontWeight: '400', marginBottom: '0px', fontSize: '15px', marginTop: '0.5rem' }} className="">Revisión Obligatoria</p>
                                    <h6 style={{ color: '#919aa3', fontWeight: '400', marginBottom: '10px', fontSize: '14px', marginTop:'0px' }} className="">{contract.revisorOtraAreaRequired ? 'Si' : 'No'}
                                    </h6>
                                </div>
    ...
    return (
        <Box className='container' sx={{ maxWidth: '95%', padding: '0 10px', margin: '0 auto', textAlign:'center' }}>
